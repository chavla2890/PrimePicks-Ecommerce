...
function sendEmail() {
  window.location.href = "mailto:akashchawla497@gmail.com";
}
    ...
    <>
      ...
      <footer>
        <div className="content">
          <div className="left box">
            <div className="upper">
              ...
              <p>
                At Prime Picks, we're passionate about providing high-quality products and exceptional customer service. Founded in 2024, our mission is to provide good quality product to our customer.
              </p>
            </div>
            <div className="lower">
        ...
        <div className="bottom">
          <p>
            Copyright © 2020 <Link to="/">Primepicks</Link> All rights reserved
          </p>
        </div>
